...
|---|---|
| `sum_of_two_numbers.m` | Adds two user-input numbers |
| `matrix_multiplication.m` | Multiplies two 3x3 matrices |
| `greater_number.m` | Finds the greater of two numbers |
| `for_loop_display.m` | Displays vector elements using a for loop |

---

# Example MATLAB Concepts Used
